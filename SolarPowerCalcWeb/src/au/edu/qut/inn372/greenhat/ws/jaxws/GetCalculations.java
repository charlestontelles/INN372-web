...
@XmlRootElement(name = "getCalculations", namespace = "http://ws.greenhat.inn372.qut.edu.au/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCalculations", namespace = "http://ws.greenhat.inn372.qut.edu.au/")
