...
@XmlRootElement(name = "deleteCalculation", namespace = "http://ws.greenhat.inn372.qut.edu.au/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deleteCalculation", namespace = "http://ws.greenhat.inn372.qut.edu.au/")
