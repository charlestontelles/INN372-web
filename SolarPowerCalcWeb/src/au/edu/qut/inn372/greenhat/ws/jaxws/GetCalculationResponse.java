...
@XmlRootElement(name = "getCalculationResponse", namespace = "http://ws.greenhat.inn372.qut.edu.au/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCalculationResponse", namespace = "http://ws.greenhat.inn372.qut.edu.au/")
