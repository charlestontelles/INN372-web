...
public class SeleniumTests {
	...
	public void register() {
		WebElement element = driver.findElement(By
				.name("tabView:loginForm:register"));
		element.click();
		...
		WebElement password = driver.findElement(By
				.name("form:userProfilePassword"));
		password.sendKeys("1234");

		WebElement passwordAgain = driver.findElement(By
	...
	public void verifyLogin() {
		...
		// WebElement element =
		// driver.findElement(By.name("j_id_jsp_793657187_1:j_id_jsp_793657187_8"));
		WebElement user = driver.findElement(By
				.name("tabView:loginForm:inputTextEmail"));
		user.clear();
		user.sendKeys("jay@greenhat.com");

		WebElement pwd = driver.findElement(By
				.name("tabView:loginForm:inputSecretPassword"));
		pwd.sendKeys("1234");

		WebElement btn = driver.findElement(By
				.name("tabView:loginForm:buttonLogin"));
		btn.click();
		/*
		 * WebElement element2 = driver.findElement(By.name("j_idt12:j_idt18"));
		 * element2.clear(); element2.sendKeys("1234");
		 * 
	...
	public void createNewCalculation() {
		WebElement newBtn = driver.findElement(By
				.name("tabView:form:savedCalculators:new"));
		newBtn.click();
	...
	public void verifyCustomerUsage() {
		...
		WebElement usageElement = driver.findElement(By
				.name("tabView:customerUsageForm:j_idt50"));
		usageElement.clear();
		usageElement.sendKeys("44.0");

		WebElement usageHoursElement = driver.findElement(By
				.name("tabView:customerUsageForm:j_idt52"));
		usageHoursElement.clear();
		usageHoursElement.sendKeys("4.5");

		WebElement usageTariff11 = driver.findElement(By
				.name("tabView:customerUsageForm:j_idt56"));
		usageTariff11.clear();
		usageTariff11.sendKeys("0.2134");

		WebElement usageFeedInTariff = driver.findElement(By
				.name("tabView:customerUsageForm:j_idt58"));
	...
	public void verifyEquipement() {
		...
		WebElement elementEquip = driver.findElement(By
				.name("tabView:equipmentForm:select"));
	...
	public void verifyBanks() {
		...
		WebElement bank1 = driver.findElement(By
				.name("tabView:roofForm:bank1NumberOfPanels"));
		bank1.clear();
		bank1.sendKeys("4");

		WebElement bank2 = driver.findElement(By
				.name("tabView:roofForm:bank2NumberOfPanels"));
		bank2.clear();
		bank2.sendKeys("4");
	}
	...
	public void verifyCalculate() {
		...
		WebElement hours = driver.findElement(By
				.name("tabView:summaryInputForm:sunlightHours"));
		hours.clear();
		...
		WebElement calculate = driver.findElement(By
				.name("tabView:summaryInputForm:j_idt136"));
		calculate.click();
		try {
			Thread.sleep(timeout);
		} catch (InterruptedException e) {
